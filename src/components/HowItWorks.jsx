...
const HowItWorks = () => {
  // Animation variant for the container to coordinate children
  const containerVariants = {
    hidden: { opacity: 0 },
    visible: {
      opacity: 1,
      transition: {
        staggerChildren: 0.2, // Delays each card by 0.2s
      },
    },
  };
  ...
  return (
    <div className='relative z-10 bg-white px-6 md:px-24 py-16 md:py-20'>
      <div className='flex items-center flex-col max-w-7xl mx-auto'>
        ...
        <motion.div 
          ...
          className='grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mt-20 md:mt-[63.99px]'
        >
          {/* STEP 01 */}
          <motion.div variants={cardVariants} className='relative flex flex-col bg-white shadow-md pt-8 pb-10 px-8 rounded-2xl border border-gray-50'>
